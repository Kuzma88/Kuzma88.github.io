...
$(function(){$(".menuMain__item").hover(function(){$(".sub_menu",this).stop().slideDown(400)},function(){$(".sub_menu",this).stop().slideUp(400)}),$(".toggle-mnu").click(function(){return $(this).toggleClass("on"),$(".hidden-menu").slideToggle(),!1}),$(document).ready(function(){$("#header").removeClass("default"),$(window).scroll(function(){$(this).scrollTop()>20?$("#header").addClass("default").fadeIn():$("#header").removeClass("default").fadeIn()})}),$(".homeCarousel").owlCarousel({loop:!0,items:1,autoplay:!0,autoplayTimeout:1e4,smartSpeed:3e3}),$(".slider-for").slick({slidesToShow:1,slidesToScroll:1,speed:1500,draggable:!1,asNavFor:".slider-nav"}),$(".slider-nav").slick({slidesToShow:1,arrows:!1,speed:1e3,draggable:!1}),$("body").append('<div class="top"><i class="fa fa-angle-up">'),$(".top").click(function(){$("html, body").animate({scrollTop:0},"slow")}),$(window).scroll(function(){$(this).scrollTop()>$(this).height()+20?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".services__item>p").equalHeights(),$(window).paroller(),$(window).on("load",function(){var e=$("#loader");e.find(".svg_anm").fadeOut(),e.delay(200).fadeOut("slow")})});